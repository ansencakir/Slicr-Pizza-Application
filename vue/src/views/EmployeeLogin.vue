...
<body>
  <div id="login" class="text-center">
    <form class="form-signin" @submit.prevent="login">
      <h1 class="h3 mb-3 font-weight-normal">Log in to your Employee Account</h1>
      <div
      ...
      />
      <div id="registration">
      <b><router-link v-bind:to="{ name: 'employee-register' }">Need an employee account?</router-link></b>
      </div>
